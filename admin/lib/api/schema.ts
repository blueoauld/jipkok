...
export interface paths {
    ...
    "/api/diaries/export": {
        ...
        /**
         * 일기 내보내기
         * @description 내 일기 전체를 오래된 날짜부터 첨부의 서명 URL과 함께 준다.
         */
...
export interface components {
    schemas: {
        ...
        CursorResponseDiaryResponse: {
            items: components["schemas"]["DiaryResponse"][];
            /** Format: int64 */
            nextCursor?: number | null;
        };
        ChatRoomResponse: {
...
export interface operations {
    ...
    write: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["WriteDiaryRequest"];
            };
        };
        responses: {
            /** @description No Content */
    ...
    search_1: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CursorResponseDiaryResponse"];
                };
            };
            /** @description 요청이 올바르지 않다 */
            400: {
