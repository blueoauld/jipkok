...
export const ja: typeof ko = {
  ...
  error: {
    ...
    BLOCK_001: "自分自身はブロックできません。",
    POINT_001: "ポイントが足りません。",
    AD_001: "広告報酬の署名が正しくありません。",
    FEED_001: "この時間にはすでに投稿しました。",
    FEED_002: "投稿が見つかりません。",
    FEED_003: "すでに通報した投稿です。",
    CHAT_001: "自分自身にはメッセージを送れません。",
    CHAT_002: "相手がメッセージを受け取っていません。",
    CHAT_003: "メッセージを送れません。",
