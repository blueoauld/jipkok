...
export const ja: typeof ko = {
  ...
  error: {
    ...
    AI_001: "AIアカウントが見つかりません。",
    AI_002: "返信の遅延は最小値が最大値を超えることはできません。",
    AI_003: "OpenAIキーがないためAIの返信を作成できません。",
  },
  feed: {
  ...
  a11y: {
    ...
    clearText: "消去",
    photoAt: "写真 {{number}}",
    secretPhotoAt: "シークレット写真 {{number}}",
    addPhoto: "写真を追加",
    removePhoto: "写真を削除",
    movePhotoForward: "前に移動",
    movePhotoBackward: "後ろに移動",
    primaryPhoto: "メイン写真",
    notificationOn: "通知をオン",
    notificationOff: "通知をオフ",
    pin: "固定",
    unpin: "固定を解除",
    comment: "コメント",
  },
